...
@click.option(
    "--reference-year", type=int, default=1750, show_default=True, help="Reference Year"
)
@click.option(
    "--nsamps",
    type=int,
...
@click.option(
    "--pyear-end", type=int, default=2100, show_default=True, help="Projection year end"
)
@click.option(
    "--output-climate-file",
    type=str,
